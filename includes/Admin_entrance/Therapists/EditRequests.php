            ...
            ?>
                <table class="table">
                    <thead>
                        ...
                        <th scope="col">Change Therapist</th>
                    ...
                    <tbody>
                    <?php
                        $sql = " SELECT  Request_ID, Time_stamp, Bed_number, Request_type, Status, Therapist, Division_name, Room_number  from REQUESTS WHERE Status='New' OR Status='In Process'";
                        ...
                        if($result->num_rows >0 )  
                        {
                                ...
                                while($row =$result->fetch_assoc()){
                                    ...
                                    echo sprintf($rowTemplate, $requestID, $row['Time_stamp'], $row['Request_type' ], $row['Status' ], $row['Therapist' ], $select, $row['Room_number' ], $row['Bed_number' ], $row['Division_name' ]);
                        }
                      }
                    ?>
                    </tbody>
